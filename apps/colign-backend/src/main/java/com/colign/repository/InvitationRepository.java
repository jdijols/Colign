...
public interface InvitationRepository extends JpaRepository<Invitation, Long> {
  ...
  /**
   * Used to short-circuit duplicate sends: if the same email is already pending on the same team we
   * surface the existing invitation rather than spawning a second one (the recipient already has a
   * live link).
   */
  ...
  /**
   * How many invitations a team has issued — drives the onboarding gate (a lead who hasn't invited
   * anyone yet is routed to the invite step).
   */
