 ...
 *
 * Deliberately a record of plain values rather than a JPA entity — the email
 * service must not pull from the DB on render, and the controller/service layer
 * shouldn't have to know which fields the template uses.
 */
